...
class RateByMotor:
    def __init__(self, file: str, dir: str) -> None:
        ...
        self.df_motors = pd.read_excel(f"{MAIN_PATH}/src/data/excel_data/motores_por_cabecera.xlsx", engine="calamine")
    ...
    def calculate_rate(self) -> List[Union[pd.DataFrame, str]]:
        ...
        df_rate.to_excel(f"{MAIN_PATH}/out/{self.file}_indice_por_motor.xlsx")
