...
class IndiceGomeria:
    def __init__(self, archivo: str, meses_diferencia: int) -> None:
        ...
        self.data_consumo = pd.read_excel(f"{MAIN_PATH}/src/data/excel_data/cubiertas_consumo_{self.archivo}.xlsx", engine="calamine")
    ...
    def calcular_consumo_por_mes_gomeria(self) -> None:
        ...
        df_final.to_excel(f"{MAIN_PATH}/src/data/excel_data/cubiertas_consumo_{self.archivo}.xlsx")
