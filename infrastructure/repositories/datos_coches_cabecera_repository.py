...
from infrastructure.db.models.datos_coches_cabecera_model import CochesCabeceraModel
from infrastructure.mappers.datos_coches_cabecera_mapper import CochesCabeceraMapper
