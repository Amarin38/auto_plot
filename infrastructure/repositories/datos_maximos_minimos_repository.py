...
from infrastructure.db.models.datos_maximos_minimos_model import MaximosMinimosModel
from infrastructure.mappers.datos_maximos_minimos_mapper import MaximosMinimosMapper
