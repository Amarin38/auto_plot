...
class GarantiasDatosRepository:
    def __init__(self, session: Session) -> None:
        self.session = session

    # Create -------------------------------------------
    def insert_many(self, entities: List[GarantiasDatos]) -> None:
        models = [Mapper.to_model(entity, GarantiasDatosModel) for entity in entities]
    ...
    def get_all(self) -> List[GarantiasDatos]:
        ...
        return [Mapper.to_entity(model, GarantiasDatos) for model in models]
    ...
    def get_by_id(self, _id: int) -> GarantiasDatos:
        ...
        return Mapper.to_entity(model, GarantiasDatos)
