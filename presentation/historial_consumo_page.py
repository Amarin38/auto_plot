...
from config.constants import PAG_HISTORIAL, DISTANCE_COLS_SELECTBIGGER_PLOT, DISTANCE_COLS_CENTER_TITLE, \
    PLOT_BOX_HEIGHT, MULTIPLE_PLOT_BOX_HEIGHT, SELECT_BOX_HEIGHT
from utils.streamlit_utils import select_box_cabecera, select_box_repuesto, select_box_tipo_repuesto, centered_title
